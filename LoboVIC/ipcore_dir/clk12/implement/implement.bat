...
xst -ifn xst.scr
move clk12_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk12_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk12_exdes.ucf clk12_exdes

echo 'Running map'
map -timing -pr b clk12_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk12_exdes -w routed.ncd routed.v
cd ..
